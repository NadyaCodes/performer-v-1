...
export default function NoPrograms() {
  return (
    <div className="m-1 flex w-11/12 flex-col place-self-center pt-4 text-center text-lg font-bold text-cyan-900 md:text-2xl mobileMenu:w-10/12 lg:pt-16 xl:w-full xl:pr-16 3xl:-ml-20">
      <div
