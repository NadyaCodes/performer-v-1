...
export default function Form({
  ...
  const matchingError = formErrors.find(
    (element) => element.tempId === elementData.tempId
  );
      ...
      <form className="w-full max-w-xl p-3">
        <div className="-mx-3 mb-6 flex flex-wrap">
          <div className="w-full px-3">
            ...
            <div className={matchingError?.schoolName ? errorBorder : ""}>
              <input
                className="block w-full appearance-none rounded bg-gray-200 px-4 py-3 leading-tight text-gray-700 focus:bg-white focus:outline-none"
                id="school-name"
                type="text"
                placeholder="Name"
                value={elementData.schoolName}
                onChange={(e) =>
                  updateForm(e.target.value, "schoolName", index)
                }
              />
            </div>
          </div>
        ...
        <div className="-mx-3 mb-6 flex flex-wrap">
          <div className="mb-6 w-full px-3 md:mb-0 md:w-1/2">
            ...
            <div className={matchingError?.city ? errorBorder : ""}>
              <input
                className="block w-full appearance-none rounded bg-gray-200 px-4 py-3 leading-tight text-gray-700 focus:bg-white focus:outline-none"
                id="school-city"
                type="text"
          ...
          <div className="w-full px-3 md:w-1/2">
            ...
            <div className={matchingError?.province ? errorBorder : ""}>
        ...
        <div className="-mx-3 mb-6 flex flex-wrap">
          <div className="w-full px-3">
            ...
            <div className={matchingError?.website ? errorBorder : ""}>
              <input
          ...
          <div className="mb-6 flex flex-wrap md:w-1/3">
            <div className="w-full px-3">
              <label className="block font-bold text-gray-500">
                Program Type
                <div className={matchingError?.type ? errorBorder : ""}>
                  <div className="m-2">
          ...
          <div className="mb-2 flex flex-wrap md:w-2/3">
            <div className="mb-6 flex w-full flex-wrap">
              <div className="w-full px-3">
                <label className="block font-bold text-gray-500">
                  Disciplines Offered
                  <div className={matchingError?.discipline ? errorBorder : ""}>
                    <div className="m-2">
                      <label className="block font-bold text-gray-500">
                        <input
                          className="mr-2 leading-tight"
